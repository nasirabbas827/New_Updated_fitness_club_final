...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM members WHERE email = '$email' AND password = "YOUR_OWN_API_KEY" AND status = 'verified'";
    ...
    if ($result->num_rows == 1) {
        ...
        $loginError = "Invalid email or password. Please try again or verify your email.";
    }
}
?>
