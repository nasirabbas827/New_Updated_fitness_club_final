...
// Fetch member data and fee information including the status
$sql = "SELECT m.MemberID, m.profileimage, m.name, m.gender, m.email, m.phone, m.address, 
        m.membership_start_date, m.membership_expiry_date, ml.level_name, ml.price, p.PaymentAmount, p.PaymentDate, m.status
        FROM members AS m
